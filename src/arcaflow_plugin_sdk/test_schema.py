        ...
        class TestData:
            union: typing.Annotated[
                typing.Union[
                    ...
                    typing.Annotated[
                        Basic2, schema.discriminator_value("Basic2")
                    ],
                    typing.Annotated[
...
class JSONSchemaTest(unittest.TestCase):
    ...
    def test_stressng_schema(self):
        ...
        class CpuStressorParams(CommonStressorParams):
            cpu_count: int = dataclasses.field(
                metadata={
                    "name": "CPU count",
                    "description": "Number of CPU cores to be used (0 means all)",
                }
            )
            cpu_method: typing.Optional[str] = dataclasses.field(
                default="all",
                metadata={
            ...
            cpu_load: typing.Optional[int] = dataclasses.field(
                default=None,
                metadata={
                    "name": "CPU load",
        ...
        class VmStressorParams(CommonStressorParams):
            ...
            vm_bytes: str = dataclasses.field(
                metadata={
                    "name": "VM memory",
            ...
            mmap: typing.Optional[str] = dataclasses.field(
                default=None,
                metadata={
                    "name": "mmap",
        ...
        class HDDStressorParams(CommonStressorParams):
            ...
            hdd_bytes: str = dataclasses.field(
                metadata={
            ...
            hdd_write_size: str = dataclasses.field(
                metadata={
                    "name": "Write Size",
                    "description": (
        ...
        class StressNGParams:
            ...
            stressors: typing.List[
                typing.Annotated[
                    typing.Union[
                        typing.Annotated[
                            CpuStressorParams,
                            schema.discriminator_value("cpu"),
                        ...
                        typing.Annotated[
                            ...
                            schema.discriminator_value("matrix"),
                        ...
                        typing.Annotated[
                            HDDStressorParams,
                            schema.discriminator_value("hdd"),
                    ...
                    schema.discriminator("stressor", discriminator_inlined=True),
                    schema.name("Stressors List"),
                    schema.description("List of stress-ng stressors and parameters"),
                ]
            ]
            verbose: typing.Optional[bool] = dataclasses.field(
                default=None,
                metadata={"name": "verbose", "description": "verbose output"},
            )
            metrics_brief: typing.Optional[bool] = dataclasses.field(
                default=None,
                metadata={
                    "name": "brief metrics",
            ...
            workdir: typing.Optional[str] = dataclasses.field(
                default=None,
                metadata={
                    "name": "Working Dir",
                    "description": (
        ...
        class WorkloadParams:
            StressNGParamsUnion: typing.Annotated[
                StressNGParams,
        ...
        s = schema.build_object_schema(WorkloadParams)
